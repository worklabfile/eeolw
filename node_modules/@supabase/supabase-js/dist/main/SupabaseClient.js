    ...
    _listenForAuthEvents() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.auth.onAuthStateChange((event, session) => {
                setTimeout(() => __awaiter(this, void 0, void 0, function* () { return yield this._handleTokenChanged(event, 'CLIENT', session === null || session === void 0 ? void 0 : session.access_token); }), 0);
            });
        });
    }
